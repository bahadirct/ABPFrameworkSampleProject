...
namespace FTS.MovieStream.Migrations
{
    ...
    [Migration("20221207073122_ValueObject_Added")]
    partial class ValueObject_Added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FTS.MovieStream.Movies.CastMember", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("FTS.MovieStream.Movies.Movie", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("FullMovieUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FTS.MovieStream.Movies.CastMember", b =>
                {
                    b.HasOne("FTS.MovieStream.Movies.Movie", null)
            ...
            modelBuilder.Entity("FTS.MovieStream.Movies.Movie", b =>
                {
                    b.OwnsOne("FTS.MovieStream.Movies.Information", "Information", b1 =>
                        {
                            ...
                            b1.Property<string>("ProductionCompany")
                                .HasColumnType("nvarchar(max)");
